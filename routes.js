...
routes.add('/entities/show', '/entities/:entityAddress')
...
routes.add('/entities/:entityAddress/token/:tokenAddress/crowdsale/:crowdsaleAddress/show', '/entities/token/crowdsale/show')
